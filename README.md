...
Api responsável por gerenciar os produtos da aplicação de Sistema de Gerenciamento de Fast Food.

## **Objetivo**
A API de produtos possui as ferramentas que possibilitam ao cliente, criar, editar, pesquisar, alterar e deletar produtos.
